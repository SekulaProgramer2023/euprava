...
func main() {
	...
	router.HandleFunc("/{sobaId}", handlers.GetReviewsBySobaHandler).Methods("GET", "OPTIONS")
	router.HandleFunc("/average/{sobaId}", handlers.GetAverageRatingHandler).Methods("GET", "OPTIONS")
	...
	fmt.Println("Review service started on port 8086")
